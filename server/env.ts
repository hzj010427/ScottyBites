...
export const EMAIL: string = process.env.EMAIL ?? 'unknown';
export const EMAIL_PW: string = process.env.EMAIL_PW ?? 'unknown';
export const EMAIL_SERVICE: string = process.env.EMAIL_SERVICE ?? 'unknown';
export const VERIFICATION_EXP: number = parseInt(process.env.VERIFICATION_EXP ?? '10000', 10);

// Mapbox API
export const MAPBOX_ACCESS_TOKEN: string = process.env.MAPBOX_ACCESS_TOKEN ?? 'unknown';
